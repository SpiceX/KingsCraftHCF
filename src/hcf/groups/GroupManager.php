...
class GroupManager implements GroupIdentifiers {
    ...
    public function init(): void {
        ...
        $this->addGroup(new Group("KingsHCF", TextFormat::RED . TextFormat::BOLD . "Valet", self::PRIMAL, 600,
            TextFormat::RED . "⚔ " . TextFormat::DARK_AQUA . "{faction_rank}{faction} ". TextFormat::BLUE . TextFormat::BOLD . "KingsHCF" . TextFormat::RESET . TextFormat::WHITE . " {player}" . TextFormat::GRAY . ": " . TextFormat::WHITE . "{message}",
            TextFormat::DARK_AQUA . "{faction_rank}{faction} ". TextFormat::BLUE . TextFormat::BOLD . "Kings§9HCF" . TextFormat::RESET . TextFormat::WHITE . " {player}", [
                "kit.food",
                "kit.starter",
                "kit.junior",
                "kit.grand",
