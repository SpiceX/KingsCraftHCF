    ...
    public function execute(CommandSender $sender, string $commandLabel, array $args): void {
        ...
        switch($sender->getGroup()->getIdentifier()) {
            ...
            case Group::PRIMAL:
                ...
                $sender->getInventory()->addItem((new CrateKey($this->getCore()->getCrateManager()->getCrate(Crate::LEGENDARY)))->setCount(5));
                break;
            default:
                $sender->addLives(15);
                $sender->getInventory()->addItem((new CrateKey($this->getCore()->getCrateManager()->getCrate(Crate::UNCOMMON)))->setCount(12));
                $sender->getInventory()->addItem((new CrateKey($this->getCore()->getCrateManager()->getCrate(Crate::COMMON)))->setCount(10));
                $sender->getInventory()->addItem((new CrateKey($this->getCore()->getCrateManager()->getCrate(Crate::LEGENDARY)))->setCount(8));
                break;
        }
        $sender->setReclaimed();
