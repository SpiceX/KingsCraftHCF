...
use hcf\command\types\CrateCommand;
use hcf\command\types\EOTWCommand;
use hcf\command\types\EraseInventoryCommand;
...
use hcf\command\types\RepairCommand;
...
use hcf\command\types\SpecialCommand;
...
use hcf\command\types\TestCommand;
...
class CommandManager {
    ...
    public function __construct(HCF $core) {
        ...
        $this->registerCommand(new SpecialCommand());
        ...
        $this->registerCommand(new EraseInventoryCommand());
